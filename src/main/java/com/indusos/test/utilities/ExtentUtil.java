package com.indusos.test.utilities;
...
public class ExtentUtil {
    ...
    public static ExtentReports createReporter(String fileName) {
        ...
        extentHtmlReporter.config().setReportName("IndusOS Automation Report");
        extentHtmlReporter.config().setDocumentTitle("IndusOS Automation Report");
        ...
        extentReports.setSystemInfo("Selenium Version", "3.13.0");
